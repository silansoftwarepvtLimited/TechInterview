    ...
    <section className="min-h-screen bg-[#F4F8FF]">
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-5 max-w-2xl text-base leading-7 text-blue-100 sm:text-lg">
              Build practical skills with professionally structured
              courses designed for beginners, students, developers,
      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div>
            <p className="text-sm font-semibold uppercase tracking-wider text-[#0057D9]">
              Explore Learning
            </p>
        ...
        {filteredCourses.length > 0 ? (
          ...
          <div className="mt-10 rounded-3xl border border-[#C9DEFF] bg-white px-6 py-24 text-center shadow-sm">
            ...
            <p className="mx-auto mt-2 max-w-md text-gray-500">
              ...
              Try searching for another technology or topic.
            </p>
          ...
          <div className="mt-16 overflow-hidden rounded-3xl bg-[#061F63] px-6 py-12 text-center shadow-xl sm:px-10">
            ...
            <div className="mx-auto max-w-2xl">
              ...
              <p className="mt-4 leading-7 text-blue-100">
                Learn programming, development, data structures,
                data science, AI, and more with CodeInterview360.
              </p>
